...
@Singleton
final class SELinuxPreferences {

	private final Resources mResources;
	private final XSharedPreferences mPreferences;

	@Inject
	SELinuxPreferences(@Snorlax Resources resources, XSharedPreferences preferences) {
	...
	private boolean getPreferenceDefaultValue() {
		return mResources.getBoolean(R.bool.preference_advanced_miscellaneous_selinux_enable);
	}

	private boolean getPreference(boolean defaultValue) {
		return mPreferences.getBoolean(mResources.getString(R.string.preference_advanced_miscellaneous_selinux_enable_key), defaultValue);
	}
}
